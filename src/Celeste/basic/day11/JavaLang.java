...
public class JavaLang {
    public static void main(String[] args) {
        ...
        // Object 클래스
        // 모든 클래스의 조상
        // toString, equals, hashCode 외 6개의 메서드가 정의되어 있음
        // 대다수 클래스는 Object 클래스가 제공하는 toString과 equals 메서드를 오버라이딩해서 사용
        ...
        // 또한 출력 횟수가 여러 번이면 코드 중복 작성
        // => 클래스의 멤버변수를 출력할 때는 toString 메서드 사용

        System.out.println( m.toString() );
        // toString 메서드를 이용해서 출력
        ...
        // 모든 메서드가 static이기 때문에 객체 생성 없이 바로 메서드 호출 가능
        ...
        // ex) 전체 게시물 수: 125, 페이지당 게시물 수: 10, 총 페이지 수?
        System.out.println(Math.ceil( (double)125 / 10) );

        // ex) 3.14159265에서 round 메서드를 이용해서 소수점 둘째 자리까지 구하면?
