...
public class EX14 {
    public static void main(String[] args) {
        ...
        int lottokey = rnd.nextInt(1000) + 1;

        // 입력값과 난수 비교
        // char lkey1 = String.valueOf(lottokey).charAt(0);
        // char lkey2 = String.valueOf(lottokey).charAt(0);
        // char lkey3 = String.valueOf(lottokey).charAt(0);
        // char ykey1 = String.valueOf(yourkey).charAt(0);
        // char ykey2 = String.valueOf(yourkey).charAt(0);
        // char ykey3 = String.valueOf(yourkey).charAt(0);
