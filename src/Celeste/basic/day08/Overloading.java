...
public class Overloading {
    public static void main(String[] args) {
        ...
        // 객체지향 3대 개녕 중 다형성에 해당. 같은 이름의 메서드를 중복해서 정의하는 것을 의미
        // 메서드의 서명을 다르게 해서 한 클래스에서 같은 이름의 메서드를 2개 이상 선언하는 것

        // 정수, 실수 매개변수를 2개 또는 3개를 이용해서 간단한 덧셈을 수행하는 프로그램
...
class NonOver {
    ...
    // 다형성이 적용되지 않으면 생성한 메서드마다 이름을 제각기 정해야 하므로,
...
class Over {
    ...
    // 다형성을 적용하면 기능은 달라도 메서드 이름이 통일되므로, 개발자가 일일히 외울 필요 없음
    // 단지 메서드를 어떻게 호출할지 알고 있으면 가
}