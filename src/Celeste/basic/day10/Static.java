...
public class Static {
    public static void main(String[] args) {
        ...
        // 개별적이고 독립적인 값이 생성/저장되는 인스턴스 변수와는 달리, 한 번 값이 생성/저장되면 모든 영역에서 값을 공유하는 변수밀

        // 객체마다 값을 개별적으로 관리해야 할 필요가 없고, 모든 클래스가 공유해야 하는 값을 유지하기 위해 사용
        // static 키워드로 선언해야 함
        // 클래스 변수는 객체의 생성 과정없이 바로 사용 가능
        ...
        m1.userid = "혜교";
        m1.passwd = "abc123";
        Member.allOfMember = 1; // 클래스 변수 호출
        ...
        // m1의 allOfMember와 m2의 allOfMember는 같은 변수를 참
    }
}
