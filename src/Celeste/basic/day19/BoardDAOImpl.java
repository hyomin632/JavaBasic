...
public class BoardDAOImpl implements BoardDAO {
    ...
    private String selectSQL = " select bdno, userid, title, mid(regdate, 1, 10) regdate , views, thumbup from board order by bdno desc ";
    ...
    private String updateSQL = " update board set title = ?, userid = ?, regdate = current_timestamp, contents = ? where bdno = ? ";
    ...
    public List<BoardVO> selectBoard() {
        ...
        try (
            ...
            while (rs.next()) {
                BoardVO bvo = new BoardVO(rs.getString(1), rs.getString(2), rs.getString(3),
    ...
    public BoardVO selectOneBoard(int bdno) {
        ...
        try (
            ...
            try (
                ...
                while (rs.next()) {
                    bvo = new BoardVO(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
